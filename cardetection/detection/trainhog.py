...
def create_or_load_descriptors(classifier_yaml, hog, window_dims):
    ...
    if req_pos_num > 0:
        ...
        pos_reg_generator = generate_samples.generate_positive_regions(pos_img_dir, bbinfo_dir, classifier_yaml['dataset']['modifiers'], window_dims)
    ...
    if req_neg_num > 0:
        ...
        neg_reg_generator = generate_samples.generate_negative_regions_with_exclusions(bak_img_dir, exl_info_map, window_dims, classifier_yaml['dataset']['modifiers'])
